...
import project.web.enums.SearchType;
...
public class SearchTypeController {
    ...
    public SearchTypeController() {
        ...
        ResourceBundle bundle = ResourceBundle.getBundle("project.web.nls.messages", FacesContext.getCurrentInstance().getViewRoot().getLocale());
        searchList.clear();
